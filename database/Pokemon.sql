...
--
-- Hôte : localhost:8889
-- Généré le : mar. 30 avr. 2024 à 10:05
...
CREATE TABLE `commandes` (
  ...
  `point_avantage` int(11) NOT NULL,
...
INSERT INTO `commandes` (`id`, `id_utilisateur`, `adresse_livraison`, `ville`, `code_postal`, `point_avantage`, `total`, `numero_commande`, `date_creation`) VALUES
(1, 2, '123 Rue des Exemples', 'Exempleville', 76400, 0, '50.00', '525ccf9ab2f7e20547924b7c0c6558', '2024-04-29 23:25:19'),
(2, 2, '26 rue gustave', 'ok', 76400, 0, '25.00', 'da04a102d803aa46e379edd9abb23', '2024-04-30 11:53:19'),
(3, 2, '25 rue pref', 'cergy', 95000, 50, '19.00', '4c57a4869c161ffa227b6ff34dfa2b', '2024-04-30 10:53:01'),
(4, 2, '25 rue pref', 'cergy', 95000, 50, '19.00', '4c57a4869c161ffa227b6ff34dfa2b', '2024-05-01 10:53:01'),
(5, 2, '25 rue pref', 'cergy', 95000, 50, '60.00', '4c57a4869c161ffa227b6ff34dfa2b', '2024-05-02 11:53:01'),
(6, 2, '25 rue pref', 'cergy', 95000, 50, '15.00', '4c57a4869c161ffa227b6ff34dfa2b', '2024-05-03 11:53:01');
...
INSERT INTO `ligne_commandes` (`id`, `id_commande`, `id_pokemon`, `quantite`) VALUES
(1, 1, 2, 3);
...
(1, 'Bulbizarre', 'plante', 'poison', 1, 0, '318.00', 0, '../img/001.png', 12, 'Pok&eacute;mon de type Plante et Poison de la premi&egrave;re g&eacute;n&eacute;ration. C&#039;est l&#039;un des Pok&eacute;mon de d&eacute;part de la r&eacute;gion de Kanto.'),
...
(2, 'Ok', 'TEST', 'ok@gmail.com', '1234567890', '06/02/2024', '$2y$12$cm0G.ve6LxPMAJQ7T4cSH.k3vkrbkth33hGQr2MY0KWojSd4ej0Oe', 'client'),
